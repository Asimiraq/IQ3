...
@font-face{font-family:'jazeera-light';src: url('https://www.fontstatic.com/fonts/jazeera-light/jazeera-light.eot?#iefix');src: local('الجزيرة خفيف'), local('stc'),url('https://www.fontstatic.com/fonts/stc/stc.ttf') format('woff');}
...
opacity: 1 !important;
    ...
    border-left: 4px solid #f7d322 !important;
    border-right: 4px solid #f7d322 !important;
...
margin-bottom: 6px;
    margin-top: 2px;
    border-radius: 15px 6px 6px 6px !important;
...
label.fl.nosel.label.pnhead {
    ...
    border-radius: 59px 0px 68px 0px !important;
    width: 130px;
...
.fl.fa.fa-sign-in.btn.btn-primary.dots.roomh.border.corner {
    background-color: #a88e34 !important;
...
#settings .tc {
    ...
    border: 1px solid #FFE0F6 !important;
...
#asim55 {
    border-top: 2px solid #f7d322;
    border-bottom: 2px solid #f7d322;
    margin-bottom: 2px;
...
body {
    background-image: url(https://g.top4top.io/p_1788q5rth1.gif);
    background-size: contain;
    background-color: #f9f9f9 !important;
}
.lonline.light.break {
    outline: #ffffff00 solid 1px !important;
    background-color: #5eb5bf3b !important;
...
$(`<link rel="stylesheet" type="text/css" href="https://www.fontstatic.com/f=stc" />
`).insertBefore("body")
$(`<a id="hussien" style="    width: 395px;
    background: url(https://k.top4top.io/p_3325lz5cc1.gif) no-repeat center center;
    background-size: 100% 100%;
    /* margin: 2px; */
    transform: matrix(1, 0, 0, 1, -4, 0);
    overflow: hidden" class="label label label-primary mini fl" target="_blank" href="soon">
    <marquee behavior='scroll' direction='right' scrollamount='3' style='width:100%; display: inline-block;'>اهلا وسهلا بكم في شات ريماس العراق</marquee></a></a>`).insertBefore('.nav-tabs');
$( "div#l1 button.btn.btn-primary" ).bind( "click", function() {
alert( "اهلا وسهلا بكم في شات ريماس العراق للجوال ❤️ سجل عضوية تحصل على 5000 لايك وزخرفة :: طريقة التسجيل اضغط على خيار (تـسجيـل )  (اكتب اسمك المستعار + كلمة المرور ) وبعدها اضغط دخول" );
});
...
`).insertBefore('label.nosel.ninr.fl.uzr.label.label-primary'),$(`<div class="uzr fl corner borderg mm bid1cb1etoid10" style="border-radius:5px;margin-bottom:-2px;width:99.5%;padding:0px; background-color:white;">
      <img style="width: 36px; height: 38px; margin-left: 1px; margin-top: 1px; background-image: url(https://fievhost.online/pic/1738666436541.png.webp);" class="fl fitimg hand u-pic    ">
      <span style="margin-top:2px;padding:0px 2px;margin-left:-20px;margin-right:4px;color:grey" class="fr minix tago" ago="1523688860481">2د</span>
      <div class="uzr fl" style="padding:0px;width:80%">
        <div style="padding:0px;width:100%;" class="fl">
          <img class="fl u-ico" alt="" src="sico/z1c9h490at10.gif">
          <span style="padding: 1px 8px; margin-top: 2px; display: block; max-width: 82%; border-radius: 3px; color: rgb(77, 75, 69); background-color: rgb(209, 204, 194);" class="corner nosel u-topic dots fl hand">　　الـ ناي　　</span>
        </div>
        <br>
        <div style="padding: 0px; width: 100%; color: rgb(0, 0, 0);" class=" u-msg   break  fl">
أرَاكَ عليَّ أقْسَى النَّاسِ قَلباً
ولي حالٌ ترقُّ لهُ القلوبُ
...
$(`<img tabindex="0" class="al120 fl " style="margin-left: -3px; padding:6px; width:35px;margin-top: -2px;" src="https://k.top4top.io/p_17044g8ns1.gif" data-original-title="" title="">`).insertAfter('img.fl.nosel.emobox');
